...
public class LadleEntity extends LivingEntity {
    ...
    public Vec3 clientPosition, vec3 = Vec3.ZERO;
    ...
    public static boolean centerPackage(Entity entity, Vec3 target) {
        if (!(entity instanceof LadleEntity LadleEntity))
            return true;
        return LadleEntity.decreaseInsertionTimer(target);
    }
    ...
    public boolean canCollideWith(Entity pEntity) {
        return pEntity instanceof LadleEntity && pEntity.getBoundingBox().maxY < getBoundingBox().minY + .125f;
    }
    ...
    public void push(Entity entityIn) {
        boolean isOtherPackage = entityIn instanceof LadleEntity;
